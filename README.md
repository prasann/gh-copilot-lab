...
> **Note:** The instructions, prompts, and agents in this repo are simplified examples to demonstrate concepts. They're not production-ready implementations - the goal is to show how these features work!

## 📁 What's in This Repo

```
.github/
├── instructions/     # Automatic coding standards
